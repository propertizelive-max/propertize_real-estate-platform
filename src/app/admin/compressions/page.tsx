...
async function loadCompressionsWithProfiles(): Promise<CompressionWithDetails[]> {
  ...
  if (profRes.error && process.env.NODE_ENV === 'development') {
...
export default function CompressionsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
        {error && (
          <div className="p-4 bg-red-50 text-red-700 text-sm" role="alert">{error}</div>
        )}
        {loading ? (
